...
| Detail | Value |
|--------|-------|
| Data Controller | Cihan Cengiz |
| Email | b.cihancengiz@gmail.com |
| App | Patify (com.bcc.buschat) |
...
- **DPA:** OneSignal standard DPA (https://onesignal.com/legal/dpa)

### 5.4 Sentry, Inc. (Functional Software, Inc.)
- **Purpose:** Error and crash monitoring
- **Location:** United States
- **DPA:** Sentry standard DPA (https://sentry.io/legal/dpa)
